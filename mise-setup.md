...
Two MCP servers are required for agent workflows in this setup:
...
Once configured, agents will use these MCPs automatically — no CLI fallback needed for ADO or GitHub operations.
