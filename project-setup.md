...
Use `/ado-ticket <parent-id>` to create a child work item under an existing parent. The skill handles inspection, drafting, creation, linking, and branch creation.
